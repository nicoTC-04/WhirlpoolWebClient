...
const Dashboard = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      await axios.post("http://localhost:5001/reporteSolucionado", {
        // datos
  ...
  const fetchReporte = async () => {
    try {
      const response = await axios.get("http://localhost:5001/reportes");
  ...
  const fetchLeaderBoard = async () => {
    try {
      const response = await axios.get("http://localhost:5001/tablero");
      console.log(response);
  ...
  const fetchTextoIA = async () => {
    try {
      const response = await axios.get("http://localhost:5001/resumenAi");
      console.log(response);
        ...
        <div className={styles.modal}>
          <div className={styles.modalContent}>
            ...
            <div className={styles.modalLeft}>
              <img
                src={`http://localhost:5001/imagen/${reporteSeleccionado?.id_reporte}`}
                alt="Report Image"
